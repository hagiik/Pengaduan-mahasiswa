		...
		<div class="row no-gutters">
			...
			<div class="col-md-8">
				<div class="card-body">
					...
					<?php if (
						$this->session->userdata('level') == 'admin' or $this->session->userdata('level') == 'staff'
						or $this->session->userdata('level') == 'sarana' or $this->session->userdata('level') == 'akademik' or $this->session->userdata('level') == 'prodi'
					) : ?>
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label">Level</label>
							<input class="form-control" type="text" placeholder="<?= $user['level']; ?>" aria-label="Disabled input example" disabled>
						</div>
