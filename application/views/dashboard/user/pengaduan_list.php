...
<div class="container-fluid mb-2">
  ...
  <div class="card no-border mb-3 col-lg-12">
    ...
    <div class="row no-gutters">
      ...
      <div class="col-md-6">
        <div class="card-body">
          <h5 class="card-title">Tanggal Pengaduan : <?= $data_pengaduan['tgl_pengaduan']; ?></h5>
          <p class="card-text">Status : <?= $data_pengaduan['status'] == 0 ? 'Belum di verifikasi' : ''; ?></p>
        <p class="card-text"><small class="text-muted">Lokasi Pengaduan : <?= $data_pengaduan['lokasi'] ?></small></p>
          <p class="card-text"><small class="text-muted">Jenis Laporan : <?= $data_pengaduan['jenis_laporan'] ?></small></p>
